...
```{r}
cars2 <- subset(mtcars, mpg >= 30 | hp < 60 )
cars2
```

Dataset taken from [Udacity website](https://www.udacity.com/course/viewer#!/c-ud651/l-729069797/e-804129319/m-811719066) R course Lesson 2.
...
# CONGRATULATIONS
#### Now, continue exploring data with your new knowledge of R.