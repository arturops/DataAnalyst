...
3. Alcohol - Positive. Higher alcohol level, higher quality
...
Surprisingly, the sulphates and the volatile acidity seem to form clusters of the red wine quality levels. This might be something very insightful to determine the quality of a red wine and these two variables might be what we are interested the most.

Let's analyze these two variables and compare them against the alcohol variable, which from level 5 quality showed a trend that higher alcohol, the higher the quality.
...
In the plot, it seems that the lower the volatile acidity and the lower the alcohol the quality is good. However, the higher the alcohol gets the volatile acidity can also increase and the quality remains good.
...
This plot shows that the higher quality wines are in a specific range of sulphates and alcohol values. We can do some counting to find these ranges.
